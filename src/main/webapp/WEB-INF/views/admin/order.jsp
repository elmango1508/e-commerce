...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav">
		...
		<div id="layoutSidenav_content">
			<main>
				<h3 class="text-center text-uppercase font-weight-bold">Order</h3>
				<hr class="w-25 m-auto">
				<form:form action="/order/index" modelAttribute="item" enctype="multipart/form-data">
